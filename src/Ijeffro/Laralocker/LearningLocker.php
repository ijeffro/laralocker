...
class LearningLocker {
  ...
  {
    $connect = new LearningLocker($key, $secret, $url);
   ...
   * @return LearningLocker
   */
  public function connection(string $key, string $secret, string $url)
  {
   ...
   * @return LearningLocker
   */
  public function check(string $key, string $secret, string $url)
  {
    $learning_locker_API = new APIHandler($key, $secret, $url);
    if ($learning_locker_API) return $learning_locker_API->testLearningLocker();
  ...
  public function personaAttribute(string $id = null)
  {
    ...
    return self::personaAttribute($id ? $id : null);
  }
  ...
  public function personaAttributes(string $id = null)
  {
    ...
    return self::personaAttributes($id ? $id : null);
  }
   ...
   */
  public function personaIdentifiers(string $id = null)
  {
    ...
    return self::personaIdentifiers($id ? $id : null);
  }
   ...
   * @return IdentifierHandler
   */
  public function personaImport(string $id = null)
  {
    $persona_identifier = new IdentifierHandler($id ? $id : null, $this->key, $this->secret, $this->url);
    if ($persona_identifier) return $persona_identifier;

    return self::personaImport($id ? $id : null);
  }
   ...
   * @return IdentifierHandler
   */
  public function personaImports(string $id = null)
  {
    $persona_identifier = new IdentifierHandler($id ? $id : null, $this->key, $this->secret, $this->url);
    if ($persona_identifier) return $persona_identifier;

    return self::personaImports($id ? $id : null);
  }
