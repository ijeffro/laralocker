...
class PersonaHandler extends APIHandler {
   ...
   */
  public function identifiers(string $id = null)
  {
    // dump($id ? $id : $this->id ? $this->id : null);

    $identifier = new IdentifierHandler($this->id ? $this->id : null, $this->key, $this->secret, $this->url);
    if ($identifier) return $identifier;

    return self::identifier($this->id ? $this->id : null);
  }
  ...
  {
    $attribute = new AttributeHandler($this->id ? $this->id : null, $this->key, $this->secret, $this->url);
    if ($attribute) return $attribute;

    return self::attributes($this->id ? $this->id : null);
  }
  ...
  public function attribute(string $id = null)
  {
    ...
    return self::attribute($this->id ? $this->id : null);
  }
