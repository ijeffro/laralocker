<?php
namespace LaraLocker\LerningLocker\Statements;
...
class XAPIHandler implements XAPIInterface {
  ...
  function __construct( Statement $statement = null, Carbon $timestamp=null  ) {
  ...
  public function send( Agent $agent, $verb, $object, Carbon $timestamp=null, Context $context=null, Result $result=null ) {
    ...
    $statement = $this->makeStatement( $agent, $verb, $object, $timestamp, $context, $result );
  ...
  public function setVersion($version){ $this->version = $version; }
    ...
    public function get() {
        try {
            $url = $this->url . $this->api . $this->v2 . $this->statementUrl . '/' . $this->id ??  $this->id;
    ...
    public function update($data) {
        try {
            $url = $this->url . $this->api . $this->v2 . $this->statementUrl . '/' . $this->id;
